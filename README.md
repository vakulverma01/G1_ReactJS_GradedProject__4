<h1 align="center">Movies on the Tip </h1>
Movies on the Tip is a React-based movie website that allows users to search for movies by title, sort them by genre, view trending and upcoming movies, and bookmark their favorite movies. The website is designed to be user-friendly and visually appealing.
<hr/>
...
Movies on the Tip is built using the following technologies:
...
![Firebase Add App Screenshot](User.jpg)

![Firebase Build App Screenshot](User.jpg)
